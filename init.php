...
if(!class_exists('DDbmovies')){
    ...
    class DDbmovies{
        ...
        public function Init(){
            ...
            define('DBMOVIES_TMDBAPI', DBMOVIES_BYPASS ? 'https://api.dbmvs.com/tmdb/json/3' : 'https://api.themoviedb.org/3');

            define('DBMOVIES_TMDBIMG', DBMOVIES_BYPASS ? 'https://api.dbmvs.com/tmdb/images' : 'https://image.tmdb.org');
